...
// API untuk mengambil maksimal 10 data terbaru dari tabel power meter
app.get('/api/last_kub', (req, res) => {
    const sql = 'SELECT * FROM tb_active_power ORDER BY idPrimary DESC LIMIT 500';
...
app.get('/api/tb_pershift_kub/month/:month', (req, res) => {
