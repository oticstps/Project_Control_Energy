...
const ContentKubikal1 = () => {
  ...
  const fetchData = async () => {
    try {
        // const response = await axios.get('http://192.168.127.225:3000/api/last_kub?db=db_energy_area_compressor');
  ...
  return (
    ...
    {lastData && (
      ...
      >
        ...
        <span>
        <strong className="text-danger">{lastData.value} kWh</strong>, Data Terakhir : {lastData.date_time}
        </span>
      </div>
    )}
